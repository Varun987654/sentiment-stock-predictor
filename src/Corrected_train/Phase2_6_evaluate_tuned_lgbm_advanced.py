# src/Corrected_train/Phase2_6_evaluate_tuned_lgbm_advanced.py
...
MODEL_PATH = "models/corrected_advanced/lgbm_tuned_advanced.pkl"
...
print(f"Loading the tuned LightGBM model from {MODEL_PATH}...")
...
print("\n== Tuned LightGBM Performance on Test Data (Advanced Features) ==")
