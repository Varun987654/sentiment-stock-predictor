# src/Corrected_BTrain/build_final_dataset_complete.v2.py
...
OUT_FILE = "data/06_Features_corrected/merged_features_split_corrected_final.csv"
TICKERS = ["AAPL", "GOOGL", "TSLA"]

print("--- Starting Final, Complete Data Build Process ---")
...
if not trading_news.empty:
    ...
    trading_aggs_df = pd.concat(all_trading_aggs).sort_values('publishedAt')

if not trading_aggs_df.empty:
    df = pd.merge_asof(
...
final_feature_columns = [
    'ticker', 'bin_end_time', 'open', 'volume', 'split', 'target_return',
